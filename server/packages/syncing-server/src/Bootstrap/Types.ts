const TYPES = {
  ...
  // Repositories
  Sync_BaseSQLItemRepository: Symbol.for('Sync_BaseSQLItemRepository'),
  Sync_SQLItemRepository: Symbol.for('Sync_SQLItemRepository'),
  Sync_SyncCommandRepository: Symbol.for('Sync_SyncCommandRepository'),
  Sync_SyncCommandOutboxRepository: Symbol.for('Sync_SyncCommandOutboxRepository'),
  ...
  Sync_ORMSyncCommandRepository: Symbol.for('Sync_ORMSyncCommandRepository'),
  Sync_ORMSyncCommandOutboxRepository: Symbol.for('Sync_ORMSyncCommandOutboxRepository'),
  // Middleware
  ...
  Sync_COMMAND_TTL_MILLISECONDS: Symbol.for('Sync_COMMAND_TTL_MILLISECONDS'),
  Sync_COMMAND_OUTBOX_RETENTION_MILLISECONDS: Symbol.for('Sync_COMMAND_OUTBOX_RETENTION_MILLISECONDS'),
  Sync_COMMAND_MAINTENANCE_INTERVAL_MILLISECONDS: Symbol.for('Sync_COMMAND_MAINTENANCE_INTERVAL_MILLISECONDS'),
  // Standard Red Notes: SHADOW-BAN sync caps.
  Sync_SHADOW_BANNED_MAX_ITEMS_LIMIT: Symbol.for('Sync_SHADOW_BANNED_MAX_ITEMS_LIMIT'),
  Sync_SHADOW_BANNED_CONTENT_SIZE_TRANSFER_LIMIT: Symbol.for('Sync_SHADOW_BANNED_CONTENT_SIZE_TRANSFER_LIMIT'),
  ...
  Sync_BACKUP_FILE_LOCATION: Symbol.for('Sync_BACKUP_FILE_LOCATION'),
  ...
  Sync_ExecuteSyncCommand: Symbol.for('Sync_ExecuteSyncCommand'),
  Sync_GetSyncCommandStatus: Symbol.for('Sync_GetSyncCommandStatus'),
  ...
  Sync_NextcloudBackupRequestedEventHandler: Symbol.for('Sync_NextcloudBackupRequestedEventHandler'),
  Sync_WebDAVClient: Symbol.for('Sync_WebDAVClient'),
  Sync_WebDAVItemBackupService: Symbol.for('Sync_WebDAVItemBackupService'),
