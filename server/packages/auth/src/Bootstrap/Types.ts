const TYPES = {
  ...
  Auth_AppPasswordHttpMapper: Symbol.for('Auth_AppPasswordHttpMapper'),
  Auth_McpTokenPersistenceMapper: Symbol.for('Auth_McpTokenPersistenceMapper'),
  Auth_McpTokenHttpMapper: Symbol.for('Auth_McpTokenHttpMapper'),
  Auth_WebhookPersistenceMapper: Symbol.for('Auth_WebhookPersistenceMapper'),
  Auth_WebhookHttpMapper: Symbol.for('Auth_WebhookHttpMapper'),
  Auth_AuditLogEntryPersistenceMapper: Symbol.for('Auth_AuditLogEntryPersistenceMapper'),
  Auth_AuditLogEntryHttpMapper: Symbol.for('Auth_AuditLogEntryHttpMapper'),
  Auth_SharePersistenceMapper: Symbol.for('Auth_SharePersistenceMapper'),
  Auth_ShareHttpMapper: Symbol.for('Auth_ShareHttpMapper'),
  Auth_GroupPersistenceMapper: Symbol.for('Auth_GroupPersistenceMapper'),
  Auth_GroupHttpMapper: Symbol.for('Auth_GroupHttpMapper'),
  Auth_DeadManSwitchPersistenceMapper: Symbol.for('Auth_DeadManSwitchPersistenceMapper'),
  Auth_DeadManSwitchHttpMapper: Symbol.for('Auth_DeadManSwitchHttpMapper'),
  Auth_EmailReminderPersistenceMapper: Symbol.for('Auth_EmailReminderPersistenceMapper'),
  Auth_EmailReminderHttpMapper: Symbol.for('Auth_EmailReminderHttpMapper'),
  Auth_TrustedDevicePersistenceMapper: Symbol.for('Auth_TrustedDevicePersistenceMapper'),
  Auth_TrustedDeviceHttpMapper: Symbol.for('Auth_TrustedDeviceHttpMapper'),
  Auth_PendingMfaApprovalPersistenceMapper: Symbol.for('Auth_PendingMfaApprovalPersistenceMapper'),
  Auth_PendingMfaApprovalHttpMapper: Symbol.for('Auth_PendingMfaApprovalHttpMapper'),
  ...
  Auth_AppPasswordsController: Symbol.for('Auth_AppPasswordsController'),
  Auth_McpTokensController: Symbol.for('Auth_McpTokensController'),
  Auth_WebhooksController: Symbol.for('Auth_WebhooksController'),
  Auth_SharesController: Symbol.for('Auth_SharesController'),
  Auth_DeadManSwitchesController: Symbol.for('Auth_DeadManSwitchesController'),
  Auth_EmailRemindersController: Symbol.for('Auth_EmailRemindersController'),
  Auth_TrustedDevicesController: Symbol.for('Auth_TrustedDevicesController'),
  Auth_PendingMfaApprovalsController: Symbol.for('Auth_PendingMfaApprovalsController'),
  Auth_MagicLinkController: Symbol.for('Auth_MagicLinkController'),
  ...
  Auth_PermissionRepository: Symbol.for('Auth_PermissionRepository'),
  ...
  Auth_AppPasswordRepository: Symbol.for('Auth_AppPasswordRepository'),
  Auth_ProofOfWorkChallengeRepository: Symbol.for('Auth_ProofOfWorkChallengeRepository'),
  Auth_McpTokenRepository: Symbol.for('Auth_McpTokenRepository'),
  Auth_WebhookRepository: Symbol.for('Auth_WebhookRepository'),
  Auth_AuditLogRepository: Symbol.for('Auth_AuditLogRepository'),
  Auth_ShareRepository: Symbol.for('Auth_ShareRepository'),
  Auth_GroupRepository: Symbol.for('Auth_GroupRepository'),
  Auth_DeadManSwitchRepository: Symbol.for('Auth_DeadManSwitchRepository'),
  Auth_EmailReminderRepository: Symbol.for('Auth_EmailReminderRepository'),
  Auth_TrustedDeviceRepository: Symbol.for('Auth_TrustedDeviceRepository'),
  ...
  Auth_ORMPermissionRepository: Symbol.for('Auth_ORMPermissionRepository'),
  ...
  Auth_ORMAppPasswordRepository: Symbol.for('Auth_ORMAppPasswordRepository'),
  Auth_ORMMcpTokenRepository: Symbol.for('Auth_ORMMcpTokenRepository'),
  Auth_ORMWebhookRepository: Symbol.for('Auth_ORMWebhookRepository'),
  Auth_ORMAuditLogRepository: Symbol.for('Auth_ORMAuditLogRepository'),
  Auth_ORMShareRepository: Symbol.for('Auth_ORMShareRepository'),
  Auth_ORMGroupRepository: Symbol.for('Auth_ORMGroupRepository'),
  Auth_ORMGroupRoleRepository: Symbol.for('Auth_ORMGroupRoleRepository'),
  Auth_ORMUserGroupRepository: Symbol.for('Auth_ORMUserGroupRepository'),
  Auth_ORMDeadManSwitchRepository: Symbol.for('Auth_ORMDeadManSwitchRepository'),
  Auth_ORMEmailReminderRepository: Symbol.for('Auth_ORMEmailReminderRepository'),
  Auth_ORMTrustedDeviceRepository: Symbol.for('Auth_ORMTrustedDeviceRepository'),
  ...
  Auth_SESSION_FRESHNESS_BUFFER: Symbol.for('Auth_SESSION_FRESHNESS_BUFFER'),
  Auth_COOLDOWN_SESSION_TOKENS_TTL: Symbol.for('Auth_COOLDOWN_SESSION_TOKENS_TTL'),
  ...
  Auth_FILE_UPLOAD_PATH: Symbol.for('Auth_FILE_UPLOAD_PATH'),
  Auth_S3_BACKUP_BUCKET_NAME: Symbol.for('Auth_S3_BACKUP_BUCKET_NAME'),
  Auth_EMAIL_ATTACHMENT_MAX_BYTE_SIZE: Symbol.for('Auth_EMAIL_ATTACHMENT_MAX_BYTE_SIZE'),
  ...
  // Standard Red Notes: SIGNUP INVITE LINKS (persistence + use cases).
  Auth_SignupInviteLinkPersistenceMapper: Symbol.for('Auth_SignupInviteLinkPersistenceMapper'),
  Auth_ORMSignupInviteLinkRepository: Symbol.for('Auth_ORMSignupInviteLinkRepository'),
  Auth_SignupInviteLinkRepository: Symbol.for('Auth_SignupInviteLinkRepository'),
  Auth_SignupInviteUsePersistenceMapper: Symbol.for('Auth_SignupInviteUsePersistenceMapper'),
  Auth_ORMSignupInviteUseRepository: Symbol.for('Auth_ORMSignupInviteUseRepository'),
  Auth_SignupInviteUseRepository: Symbol.for('Auth_SignupInviteUseRepository'),
  Auth_ConsumeSignupInvite: Symbol.for('Auth_ConsumeSignupInvite'),
  ...
  Auth_DeleteMcpToken: Symbol.for('Auth_DeleteMcpToken'),
  Auth_AuthenticateWithMcpToken: Symbol.for('Auth_AuthenticateWithMcpToken'),
  Auth_GetMcpTokenKeys: Symbol.for('Auth_GetMcpTokenKeys'),
  Auth_RegisterWebhook: Symbol.for('Auth_RegisterWebhook'),
  Auth_ListWebhooks: Symbol.for('Auth_ListWebhooks'),
  Auth_DeleteWebhook: Symbol.for('Auth_DeleteWebhook'),
  Auth_WebhookDispatcher: Symbol.for('Auth_WebhookDispatcher'),
  Auth_AuditLogWriter: Symbol.for('Auth_AuditLogWriter'),
  Auth_QueryAuditLog: Symbol.for('Auth_QueryAuditLog'),
  Auth_CreateShare: Symbol.for('Auth_CreateShare'),
  Auth_ListShares: Symbol.for('Auth_ListShares'),
  Auth_RevokeShare: Symbol.for('Auth_RevokeShare'),
  Auth_GetShare: Symbol.for('Auth_GetShare'),
  Auth_CreateGroup: Symbol.for('Auth_CreateGroup'),
  Auth_ListGroups: Symbol.for('Auth_ListGroups'),
  Auth_DeleteGroup: Symbol.for('Auth_DeleteGroup'),
  Auth_AddUserToGroup: Symbol.for('Auth_AddUserToGroup'),
  Auth_RemoveUserFromGroup: Symbol.for('Auth_RemoveUserFromGroup'),
  Auth_SetGroupRoles: Symbol.for('Auth_SetGroupRoles'),
  Auth_ListGroupMembers: Symbol.for('Auth_ListGroupMembers'),
  Auth_GetUserEffectivePermissions: Symbol.for('Auth_GetUserEffectivePermissions'),
  Auth_ListRolesWithPermissions: Symbol.for('Auth_ListRolesWithPermissions'),
  Auth_SetRolePermissions: Symbol.for('Auth_SetRolePermissions'),
  Auth_CreateCustomRole: Symbol.for('Auth_CreateCustomRole'),
  Auth_DeleteCustomRole: Symbol.for('Auth_DeleteCustomRole'),
  Auth_GetPermissionCatalog: Symbol.for('Auth_GetPermissionCatalog'),
  Auth_GetRoleHolders: Symbol.for('Auth_GetRoleHolders'),
  Auth_ResolveRoleSetPermissions: Symbol.for('Auth_ResolveRoleSetPermissions'),
  Auth_CreateDeadManSwitch: Symbol.for('Auth_CreateDeadManSwitch'),
  Auth_ListDeadManSwitches: Symbol.for('Auth_ListDeadManSwitches'),
  Auth_CheckInDeadManSwitch: Symbol.for('Auth_CheckInDeadManSwitch'),
  Auth_DeleteDeadManSwitch: Symbol.for('Auth_DeleteDeadManSwitch'),
  Auth_TriggerDueDeadManSwitches: Symbol.for('Auth_TriggerDueDeadManSwitches'),
  Auth_CreateEmailReminder: Symbol.for('Auth_CreateEmailReminder'),
  Auth_ListEmailReminders: Symbol.for('Auth_ListEmailReminders'),
  Auth_DeleteEmailReminder: Symbol.for('Auth_DeleteEmailReminder'),
  Auth_TriggerDueEmailReminders: Symbol.for('Auth_TriggerDueEmailReminders'),
  Auth_CreateTrustedDevice: Symbol.for('Auth_CreateTrustedDevice'),
  Auth_ListTrustedDevices: Symbol.for('Auth_ListTrustedDevices'),
  Auth_DeleteTrustedDevice: Symbol.for('Auth_DeleteTrustedDevice'),
  Auth_VerifyTrustedDevice: Symbol.for('Auth_VerifyTrustedDevice'),
  Auth_CreatePendingMfaApproval: Symbol.for('Auth_CreatePendingMfaApproval'),
  Auth_ResolvePendingMfaApproval: Symbol.for('Auth_ResolvePendingMfaApproval'),
  Auth_GetPendingMfaApprovalStatus: Symbol.for('Auth_GetPendingMfaApprovalStatus'),
  ...
  Auth_EmailRequestedEventHandler: Symbol.for('Auth_EmailRequestedEventHandler'),
  Auth_NextcloudBackupCompletedEventHandler: Symbol.for('Auth_NextcloudBackupCompletedEventHandler'),
  ...
  Auth_WebhookItemDeletedEventHandler: Symbol.for('Auth_WebhookItemDeletedEventHandler'),
  Auth_WebhookItemsChangedEventHandler: Symbol.for('Auth_WebhookItemsChangedEventHandler'),
  // Services
  ...
  Auth_RawDomainEventPublisher: Symbol.for('Auth_RawDomainEventPublisher'),
  Auth_InviteEventTransactionContext: Symbol.for('Auth_InviteEventTransactionContext'),
  Auth_ORMInviteEventOutboxRepository: Symbol.for('Auth_ORMInviteEventOutboxRepository'),
  Auth_InviteEventOutboxRepository: Symbol.for('Auth_InviteEventOutboxRepository'),
  Auth_InviteEventOutboxDispatcher: Symbol.for('Auth_InviteEventOutboxDispatcher'),
  Auth_InviteRealtimeOutboxProducer: Symbol.for('Auth_InviteRealtimeOutboxProducer'),
  Auth_InviteMutationTransactionRunner: Symbol.for('Auth_InviteMutationTransactionRunner'),
  Auth_InviteAffectedUserResolver: Symbol.for('Auth_InviteAffectedUserResolver'),
  ...
  Auth_BaseDeadManSwitchesController: Symbol.for('Auth_BaseDeadManSwitchesController'),
  Auth_BaseEmailRemindersController: Symbol.for('Auth_BaseEmailRemindersController'),
  Auth_BaseTrustedDevicesController: Symbol.for('Auth_BaseTrustedDevicesController'),
  Auth_BasePendingMfaApprovalsController: Symbol.for('Auth_BasePendingMfaApprovalsController'),
  Auth_BaseMagicLinkController: Symbol.for('Auth_BaseMagicLinkController'),
  Auth_EmailSender: Symbol.for('Auth_EmailSender'),
  Auth_BackupAttachmentStorage: Symbol.for('Auth_BackupAttachmentStorage'),
  Auth_SMTP_HOST: Symbol.for('Auth_SMTP_HOST'),
  Auth_SMTP_PORT: Symbol.for('Auth_SMTP_PORT'),
