...
export type ConditionalPayloadType<T> =
  T extends DecryptedTransferPayload<infer C>
    ? DecryptedPayloadInterface<C>
    : T extends EncryptedTransferPayload
      ? EncryptedPayloadInterface
      : DeletedPayloadInterface

export type ConditionalTransferPayloadType<P> =
  P extends DecryptedPayloadInterface<infer C>
