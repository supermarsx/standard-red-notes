    ...
    try {
      ...
      const configurationFile: HomeServerConfigurationFile = {
        ...
        info: {
          ...
          information:
            'The values below are stored in PLAINTEXT, not encrypted. This home server runs on your own machine and this file lives inside your home server data location, so the machine itself is the trust boundary: anyone who can read this file can read these secrets. Protect it with your operating-system file permissions and, ideally, full-disk encryption.',
          instructions:
