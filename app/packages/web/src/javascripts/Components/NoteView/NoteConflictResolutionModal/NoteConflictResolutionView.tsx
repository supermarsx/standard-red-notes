...
/**
 * Standard Red Notes: the inner conflict-resolution UI (version list, preview /
 * diff, keep/trash/delete actions). Extracted from NoteConflictResolutionModal so
 * it can be rendered either inside a Modal or inline as a tab in the editor tab
 * bar. Fills its container.
 */
const NoteConflictResolutionView = ({
  currentNote,
  conflictedNotes,
  onClose,
  className,
              ...
              {showSuperConversionInfo && (
                <StyledTooltip
                  ...
                  label={
                    <>
                      <div className="mb-2">
                        Super notes use JSON under the hood to create rich and flexible documents. While neatly
...
export default NoteConflictResolutionView
