  ...
  return (
    <div className="flex h-full flex-col items-center">
      <div className="flex w-full items-center justify-between p-4">
        <h1 className="m-0 text-lg font-bold">{t('selectedFilesCount', { count })}</h1>
        <div>
      ...
      <div className="flex min-h-full w-full max-w-md flex-grow flex-col items-center justify-center">
        ...
        <h2 className="m-0 mt-4 text-center text-lg font-bold">{t('selectedFilesCount', { count })}</h2>
        <p className="mt-2 max-w-60 text-center text-sm">{t('actionsPerformedOnSelected')}</p>
        <Button className="mt-2.5" onClick={cancelMultipleSelection}>
          {t('cancelMultipleSelection')}
        </Button>
      </div>
    </div>
  )
