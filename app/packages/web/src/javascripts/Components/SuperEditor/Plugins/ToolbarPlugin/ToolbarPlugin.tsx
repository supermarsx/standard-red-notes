          ...
          >
            {canShowAllItems
              ? activeGroups.map((group) => {
                  ...
                  // first-line "Edit styles" button, and an "⋮" menu that hosts
                  // the checklist-behaviour actions (which used to live in the
                  // now-removed plain block-type dropdown). The bar grows to fill
                      ...
                      >
                        <div className="flex flex-col items-stretch justify-center gap-0.5 md:min-h-[7.375rem]">
                          <BlockStyleGalleryBar
                            ...
                            extraMenu={
                              <Menu a11yLabel={t('blockStyle')} className="!px-0">
                                <ToolbarMenuItem
