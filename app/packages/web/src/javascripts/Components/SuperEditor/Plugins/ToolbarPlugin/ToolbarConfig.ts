...
export enum ToolbarButtonId {
  ...
  SortLines = 'sortLines',
  /** @deprecated single alignment dropdown; replaced by the four toggles below. */
  Alignment = 'alignment',
  AlignLeft = 'alignLeft',
...
export const DEFAULT_TOOLBAR_GROUPS: ToolbarGroupDescriptor[] = [
  ...
  },
  {
    ...
    buttons: [
      ...
      { id: ToolbarButtonId.AlignLeft, label: 'Align left', group: ToolbarGroupId.ParagraphList },
      { id: ToolbarButtonId.AlignCenter, label: 'Align center', group: ToolbarGroupId.ParagraphList },
      { id: ToolbarButtonId.AlignRight, label: 'Align right', group: ToolbarGroupId.ParagraphList },
