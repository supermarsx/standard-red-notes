...
const fr: LocaleResource = {
  ...
  navigation: {
    ...
    noTagsFound: 'Aucune étiquette trouvée. Essayez une autre recherche.',
    noSmartViewsFound: 'Aucune vue intelligente trouvée. Essayez une autre recherche.',
    collapseTagsPanel: 'Réduire le panneau des étiquettes',
    expandTagsPanel: 'Développer le panneau des étiquettes',
