...
const editor = {
  ...
  completeAllChecklistItems: 'Mark all items completed',
  completeAllChecklistItemsDescription: 'Completes every item in the checklist your cursor or selection is in.',
  completeSelectedChecklistItems: 'Mark selected items completed',
  uncompleteSelectedChecklistItems: 'Mark selected items not completed',
  noChecklistItemsSelected: 'Place the cursor in a checklist, or select checklist items, to use this.',
  editStyles: 'Edit styles',
  reorderBlockStyles: 'Reorder',
  doneReordering: 'Done',
  resetBlockStyleOrder: 'Reset to default order',
  moveBlockStyleUp: 'Move up',
  moveBlockStyleDown: 'Move down',
