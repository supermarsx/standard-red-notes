...
const ptBR: LocaleResource = {
  ...
  editor: {
    ...
    completeAllChecklistItemsDescription: 'Conclui todos os itens da lista de tarefas onde está o cursor ou a seleção.',
    ...
    noChecklistItemsSelected: 'Coloque o cursor em uma lista de tarefas ou selecione itens para usar esta ação.',
